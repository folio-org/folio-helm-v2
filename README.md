...
| Name                                | Description                                                                                                                                                      | Common value                                                        |
|-------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|
| `integrations.NAME`                 | Defines either existing or new Secret with NAME (replace with the existing or desired name).                                                                     | `okapi`, `db`, `kafka`, `opensearch`, `systemuser`, `s3`, `eureka`  |
