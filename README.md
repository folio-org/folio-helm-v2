...
| `deploymentStrategy`               | How to replace existing pods with new ones. Default is Recreate                                                                                                                                                                                                                                                                                   | `RollingUpdate`                                                 |
...
| `envVars`                    | Adds env variables to containers via env section. These vars have to be defined only directly in the Chart. ATTENTION: Don't pass these values during values file because it will override the defined values.                                                                                                            | `[]`                                                   |
| `extraEnvVars`               | Adds env variables to containers via the env section. These vars have to be defined only directly in the Chart. ATTENTION: Don't pass these values in the values file because it will override the defined values.                                                                                                        | `[]`                                                   |
...
| `eureka.enabled`             | If values is true, Eureka related resources are created. Is disabled by default.                                                                                                                                                                                                                                          | `false`                                                |
| `eureka.envVars`             | Adds env variables to containers via env section. These vars have to be defined only directly in the Chart. ATTENTION: Don't pass these values during values file because it will override the defined values.                                                                                                            | `[]`                                                   |
| `eureka.extraEnvVars`        | Adds additional env variables to containers via the env section if eureka.enabled is true. These vars have to be defined only directly in the Chart. ATTENTION: Don't pass these values in the values file because it will override the defined values.                                                                   | `[]`                                                   |
...
| Name                                | Description                                                                                                                                                      | Common value                                                                      |
|-------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|
| `integrations.NAME`                 | Defines either existing or new Secret with NAME (replace with the existing or desired name).                                                                     | `okapi`, `db`, `kafka`, `opensearch`, `systemuser`, `s3`, `eureka`, `eureka-edge` |
...
| Name                                         | Description                                                                                                                                                                                                            | Common value                                         |
|----------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|
| `sidecarContainers.NAME`                     | The section provides sidecar information.	                                                                                                                                                                             | `eureka`                                             |
| `sidecarContainers.NAME.enabled`             | If it is true an additional container will be added to the module pod.                                                                                                                                                 | `false`                                              |
| `sidecarContainers.NAME.name`                | A container name to be used as sidecar name. If it is not provided section name is utilized.                                                                                                                           | 'sidecar'                                            |
| `sidecarContainers.NAME.image.repository`    | Sidecar container image location.                                                                                                                                                                                      |                                                      |
| `sidecarContainers.NAME.image.tag`           | Sidecar container image tag.                                                                                                                                                                                           | `latest`                                             |
| `sidecarContainers.NAME.image.pullPolicy`    | Sidecar container image pull policy.                                                                                                                                                                                   | `IfNotPresent`                                       |
| `sidecarContainers.NAME.ports.name`          | Optional part of the port specification used when a service has multiple exposed ports.                                                                                                                                | 'sidecar'                                            |
| `sidecarContainers.NAME.ports.port`          | Sidecar container TCP port number in the pod to listen on.                                                                                                                                                             | `8082`                                               |
| `sidecarContainers.NAME.ports.containerPort` | Sidecar container TCP port number to be exposed via the service.                                                                                                                                                       | `8082`                                               |
| `sidecarContainers.NAME.resources`           | Sidecar resource section.                                                                                                                                                                                              | `limits:    memory: 96Mi   requests:   memory: 64Mi` |
| `sidecarContainers.NAME.envVars`             | Adds env variables to sidecar container via this section. These vars have to be defined only directly in the Chart. ATTENTION: Don't pass these values during values file because it will override the defined values. | []                                                   |
| `sidecarContainers.NAME.extraEnvVars`        | Adds env variables to sidecar container via this section. These vars have to be defined only directly in the Chart. ATTENTION: Don't pass these values during values file because it will override the defined values. | []                                                   |
