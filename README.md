...
| `eureka.extraEnvVars`        | Adds additional env variables to containers via env section if eureka.enabled is true.                                                                                                                                                                                                                                    | `[]`                                                   |
...
| `sidecarContainers.NAME.env`                 | Adds env variables to sidecar container via this section.                                    |                                                      |
